...
setup(
    ...
    keywords='',
    project_urls={
        'Bug Tracker': 'https://github.com/KnowOntology/know.py/issues',
        'Changelog': 'https://github.com/KnowOntology/know.py/blob/master/CHANGES.md',
        'Documentation': 'https://github.com/KnowOntology/know.py/blob/master/README.md',
        'Source Code': 'https://github.com/KnowOntology/know.py',
    },
